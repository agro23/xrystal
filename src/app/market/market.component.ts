...
*/
  ...
  //   {"image": "../assets/img/xrystal15.jpg", "id": 15},
    ...
    public xrystalsGroup:Array<Object> = [
      ...
      {"image": "../assets/img/crystal2.gif", "id": 17, "price": "$1"},
      {"image": "../assets/img/crystal3.gif", "id": 5 , "price": "$1"},
      {"image": "../assets/img/crystal4.gif", "id": 33, "price": "$1"},
      {"image": "../assets/img/crystal5.gif", "id": 12, "price": "$1"},
      {"image": "../assets/img/crystal6.gif", "id": 9, "price": "$1"},
      {"image": "../assets/img/crystal7.gif", "id": 41, "price": "$1"},
      {"image": "../assets/img/crystal8.gif", "id": 37, "price": "$1"},
      {"image": "../assets/img/crystal9.gif", "id": 15, "price": "$1"},
    ...
    {"image": "../assets/img/xrystal40.jpg", "id": 40, "price": "$1"},
    {"image": "../assets/img/xrystal3.jpg", "id": 3, "price": "$1"},
    {"image": "../assets/img/xrystal16.jpg", "id": 16, "price": "$1"},
    ...
    {"image": "../assets/img/xrystal44.jpg", "id": 44, "price": "$1"},
    {"image": "../assets/img/xrystal27.jpg", "id": 27, "price": "$1"},
    {"image": "../assets/img/xrystal10.jpg", "id": 10, "price": "$1"},
    ...
    {"image": "../assets/img/xrystal42.jpg", "id": 42, "price": "$1"},
    {"image": "../assets/img/xrystal28.jpg", "id": 28, "price": "$1"},
    {"image": "../assets/img/xrystal4.jpg", "id": 4, "price": "$1"},
